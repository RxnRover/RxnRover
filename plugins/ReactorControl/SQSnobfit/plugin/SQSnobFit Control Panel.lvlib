...
<Library LVVersion="20008000">
	...
	<Item Name="process loops" Type="Folder">
		...
		<Item Name="Data Display Loop" Type="Folder">
			<Item Name="Parameter Array to String.vi" Type="VI" URL="../process loops/Data Display Loop/Parameter Array to String.vi"/>
		</Item>
		...
		<Item Name="UI Manager" Type="Folder">
			<Item Name="support" Type="Folder">
				<Item Name="Data Display Loop Data.ctl" Type="VI" URL="../process loops/UI Manager/support/Data Display Loop Data.ctl"/>
				<Item Name="UI Data.ctl" Type="VI" URL="../process loops/UI Manager/support/UI Data.ctl"/>
				<Item Name="UI Display State.ctl" Type="VI" URL="../process loops/UI Manager/support/UI Display State.ctl"/>
			</Item>
	...
	<Item Name="Typedefs" Type="Folder">
		<Item Name="Best Result.ctl" Type="VI" URL="../Typedefs/Best Result.ctl"/>
		<Item Name="Init.vi States.ctl" Type="VI" URL="../Typedefs/Init.vi States.ctl"/>
		<Item Name="Parameter.ctl" Type="VI" URL="../Typedefs/Parameter.ctl"/>
		<Item Name="Remote Optimizer State.ctl" Type="VI" URL="../Typedefs/Remote Optimizer State.ctl"/>
	</Item>
