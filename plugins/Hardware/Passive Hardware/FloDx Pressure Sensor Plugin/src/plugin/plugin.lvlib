...
<Library LVVersion="20008000">
	<Property Name="NI.Lib.ContainingLib" Type="Str">plugin_flodx_pressure.lvlib</Property>
	<Property Name="NI.Lib.ContainingLibPath" Type="Str">../../../plugin_flodx_pressure.lvlib</Property>
	...
	<Item Name="process loops" Type="Folder">
		...
		<Item Name="System Control" Type="Folder">
			<Item Name="support" Type="Folder">
				<Item Name="System Control Data.ctl" Type="VI" URL="../process loops/System Control/System Control Data.ctl"/>
			</Item>
		...
		<Item Name="UI Manager" Type="Folder">
			<Item Name="dialogs" Type="Folder">
				<Item Name="calibrateUI" Type="Folder">
					<Item Name="Calibrate.vi" Type="VI" URL="../process loops/UI Manager/dialogs/calibrateUI/Calibrate.vi"/>
				</Item>
				<Item Name="get_connection_info" Type="Folder">
					<Item Name="Get Connection Information Dialog.vi" Type="VI" URL="../process loops/UI Manager/dialogs/get_connection_info/Get Connection Information Dialog.vi"/>
				</Item>
				<Item Name="settings" Type="Folder">
					<Item Name="Display Instrument Settings.ctl" Type="VI" URL="../process loops/UI Manager/dialogs/settings/Display Instrument Settings.ctl"/>
					<Item Name="Settings Dialog.vi" Type="VI" URL="../process loops/UI Manager/dialogs/settings/Settings Dialog.vi"/>
					<Item Name="settings.ctl" Type="VI" URL="../process loops/UI Manager/dialogs/settings/settings.ctl"/>
				</Item>
			</Item>
