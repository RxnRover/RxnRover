...
<Library LVVersion="20008000">
	...
	<Item Name="Public" Type="Folder">
		<Item Name="Action-Status" Type="Folder">
			...
			<Item Name="PrintBangOnOffRange.vi" Type="VI" URL="../Public/Action-Status/PrintBangOnOffRange.vi"/>
			<Item Name="PrintCommandList.vi" Type="VI" URL="../Public/Action-Status/PrintCommandList.vi"/>
			<Item Name="PrintControlWindow.vi" Type="VI" URL="../Public/Action-Status/PrintControlWindow.vi"/>
			...
			<Item Name="PrintKd.vi" Type="VI" URL="../Public/Action-Status/PrintKd.vi"/>
			<Item Name="PrintKi.vi" Type="VI" URL="../Public/Action-Status/PrintKi.vi"/>
			<Item Name="PrintKp.vi" Type="VI" URL="../Public/Action-Status/PrintKp.vi"/>
			<Item Name="PrintMode.vi" Type="VI" URL="../Public/Action-Status/PrintMode.vi"/>
			<Item Name="PrintSetpoint.vi" Type="VI" URL="../Public/Action-Status/PrintSetpoint.vi"/>
			<Item Name="PrintSetpointMax.vi" Type="VI" URL="../Public/Action-Status/PrintSetpointMax.vi"/>
			<Item Name="PrintSetpointMin.vi" Type="VI" URL="../Public/Action-Status/PrintSetpointMin.vi"/>
			<Item Name="PrintStandbyMode.vi" Type="VI" URL="../Public/Action-Status/PrintStandbyMode.vi"/>
			...
			<Item Name="SetBangOnOffRange.vi" Type="VI" URL="../Public/Action-Status/SetBangOnOffRange.vi"/>
			<Item Name="SetControlWindow.vi" Type="VI" URL="../Public/Action-Status/SetControlWindow.vi"/>
			<Item Name="SetMode.vi" Type="VI" URL="../Public/Action-Status/SetMode.vi"/>
			<Item Name="SetSetpoint.vi" Type="VI" URL="../Public/Action-Status/SetSetpoint.vi"/>
			<Item Name="SetSetpointMax.vi" Type="VI" URL="../Public/Action-Status/SetSetpointMax.vi"/>
			<Item Name="SetSetpointMin.vi" Type="VI" URL="../Public/Action-Status/SetSetpointMin.vi"/>
			<Item Name="SetStandbyMode.vi" Type="VI" URL="../Public/Action-Status/SetStandbyMode.vi"/>
			<Item Name="SetVerboseMode.vi" Type="VI" URL="../Public/Action-Status/SetVerboseMode.vi"/>
			<Item Name="TUNEPID.vi" Type="VI" URL="../Public/Action-Status/TUNEPID.vi"/>
		</Item>
