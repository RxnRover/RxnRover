...
&lt;fill in information about manufacturer, model, and type of the instrument&gt;.</Property>
	...
	<Item Name="Public" Type="Folder">
		...
		<Item Name="Action-Status" Type="Folder">
			<Item Name="Action-Status.mnu" Type="Document" URL="/&lt;instrlib&gt;/ChromTech MX-Class Pump/Public/Action-Status/Action-Status.mnu"/>
			...
			<Item Name="Status Get User Compensation.vi" Type="VI" URL="../Public/Action-Status/Status Get User Compensation.vi"/>
			...
			<Item Name="Status Prime Status.vi" Type="VI" URL="../Public/Action-Status/Status Prime Status.vi"/>
			<Item Name="Status Pump Status.vi" Type="VI" URL="../Public/Action-Status/Status Pump Status.vi"/>
			<Item Name="Status Faults.vi" Type="VI" URL="../Public/Action-Status/Status Faults.vi"/>
		</Item>
		<Item Name="Configure" Type="Folder">
			<Item Name="Configure.mnu" Type="Document" URL="/&lt;instrlib&gt;/ChromTech MX-Class Pump/Public/Configure/Configure.mnu"/>
			<Item Name="Configure Flow Rate.vi" Type="VI" URL="../Public/Configure/Configure Flow Rate.vi"/>
			<Item Name="Configure User Compensation.vi" Type="VI" URL="../Public/Configure/Configure User Compensation.vi"/>
		</Item>
		<Item Name="Data" Type="Folder">
			...
			<Item Name="Data.mnu" Type="Document" URL="/&lt;instrlib&gt;/ChromTech MX-Class Pump/Public/Data/Data.mnu"/>
		</Item>
		<Item Name="Utility" Type="Folder">
			<Item Name="Utility Clear Buffer.vi" Type="VI" URL="../Public/Utility/Utility Clear Buffer.vi"/>
			<Item Name="Utility Error Query.vi" Type="VI" URL="../Public/Utility/Utility Error Query.vi"/>
			<Item Name="Utility Fast Comms.vi" Type="VI" URL="../Public/Utility/Utility Fast Comms.vi"/>
			...
			<Item Name="Utility Format User Compensation.vi" Type="VI" URL="../Public/Utility/Utility Format User Compensation.vi"/>
			<Item Name="Utility Head ID.vi" Type="VI" URL="../Public/Utility/Utility Head ID.vi"/>
			<Item Name="Utility Log to File.vi" Type="VI" URL="../Public/Utility/Utility Log to File.vi"/>
			<Item Name="Utility Maximum Flow.vi" Type="VI" URL="../Public/Utility/Utility Maximum Flow.vi"/>
			<Item Name="Utility Parse Flow Rate.vi" Type="VI" URL="../Public/Utility/Utility Parse Flow Rate.vi"/>
			<Item Name="Utility Parse User Compensation.vi" Type="VI" URL="../Public/Utility/Utility Parse User Compensation.vi"/>
			<Item Name="Utility Reset.vi" Type="VI" URL="../Public/Utility/Utility Reset.vi"/>
			<Item Name="Utility Revision Query.vi" Type="VI" URL="../Public/Utility/Utility Revision Query.vi"/>
			<Item Name="Utility.mnu" Type="Document" URL="/&lt;instrlib&gt;/ChromTech MX-Class Pump/Public/Utility/Utility.mnu"/>
		</Item>
		<Item Name="dir.mnu" Type="Document" URL="/&lt;instrlib&gt;/ChromTech MX-Class Pump/Public/dir.mnu"/>
	...
	<Item Name="ChromTech MX-Class Drivers.html" Type="Document" URL="/&lt;instrlib&gt;/ChromTech MX-Class Pump/ChromTech MX-Class Drivers.html"/>
</Library>
