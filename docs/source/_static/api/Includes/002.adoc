...
|image:RxnRover.lvlib_Load_Log_Config_from_Preferences.vi.png[RxnRover.lvlib:Load Log Config from Preferences.vi]
|Updates the log configuration based on user preferences. This VI serves as a link between a User Preferences File object and the logging library without directly coupling the two.

NOTE: The provided User Preferences object must already be initialized.

To view or update the log configuration at runtime, use the logging.lvlib:Set Log Config.vi and logging.lvlib:Get Log Config.vi VIs.
|image:empty.png[empty.png]
|image:empty.png[empty.png]
|image:empty.png[empty.png]

|Save Log Config to Preferences
|image:RxnRover.lvlib_Save_Log_Config_to_Preferences.vi.png[RxnRover.lvlib:Save Log Config to Preferences.vi]
|Stores the log configuration to the provided user preferences object. It does not save the user preferences to a file! This VI serves as a link between a User Preferences File object and the logging library without directly coupling the two.
...
|image:RxnRover.lvlib_Load_and_Apply_User_Preferences.vi.png[RxnRover.lvlib:Load and Apply User Preferences.vi]
